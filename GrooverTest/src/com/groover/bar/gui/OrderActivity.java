...
public class OrderActivity extends Activity implements OnItemClickListener,
	...
	private String[] FROM_A = new String[] {
			DBHelper.ItemList.COLUMN_NAME_ITEM,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		a_artikelen = new SimpleCursorAdapter(this, R.layout.article_row2,
				c_Articles, FROM_A, TO_A,
